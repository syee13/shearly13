<div class="content-wrapper">
    ...
    <section class="content">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?= base_url('matakuliah/update/'. $matakuliah['kode_matkul']); ?>" method="POST">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="kode_matakuliah">Kode Mata Kuliah</label>
                            <input type="text" class="form-control" name="kode_matkul" value="<?= $matakuliah['kode_matkul']; ?>" id="kode_matkul" required>
                        </div>
                        <div class="form-group">
                            <label for="nama_matakuliah">Nama Mata Kuliah</label>
                            <input type="text" class="form-control" name="nama_matkul" value="<?= $matakuliah['nama_matkul']; ?>" id="nama_matkul" required>
                        </div>
                        <div class="form-group">
